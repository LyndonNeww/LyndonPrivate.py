...
def usage():
    ...
    print "Tools Private Lyndon  "
    print "Tools By Lyndon Weirdly"
    print "JANGAN ABUSE!! KALO ABUSE AKAN SAYA HAPUS"
...
def flood(victim, vport, duration):
    ...
    while 1:
        ...
        sent = sent + 1
        print "Attacking %s Server &  %s By Lyndon%s "%(sent, victim, vport)
